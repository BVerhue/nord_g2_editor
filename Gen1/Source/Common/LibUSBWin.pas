...
function usb_strerror: PAnsiChar; cdecl;
...
function  usb_install_driver_np(inf_file: PAnsiChar): integer; cdecl;
function  usb_get_version: pusb_version; cdecl; 
function  usb_isochronous_setup_async(dev: pusb_dev_handle; var context: pointer; ep: PAnsiChar; pktsize: integer): integer; cdecl;
function  usb_bulk_setup_async(dev: pusb_dev_handle; var context: pointer; ep: PAnsiChar): integer; cdecl;
function  usb_interrupt_setup_async(dev: pusb_dev_handle; var context: pointer; ep: PAnsiChar): integer; cdecl;
...
function  usb_reap_async_nocancel(context: pointer; timeout: integer): integer; cdecl;
function  usb_cancel_async(context: pointer): integer; cdecl;
...
function  usb_strerror: PAnsiChar; cdecl; external LIBUSB_DLL_NAME name 'usb_strerror';
...
function  usb_reap_async_nocancel; cdecl; external LIBUSB_DLL_NAME name 'usb_reap_async_nocancel';
function  usb_cancel_async; cdecl; external LIBUSB_DLL_NAME name 'usb_cancel_async';
