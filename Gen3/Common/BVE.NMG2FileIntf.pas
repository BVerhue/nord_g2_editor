...
type
  ...
  IG2Connector = interface(IG2Subject)
    ...
    property ModuleIndex: byte read GetModuleIndex;
    property LocationIndex: byte read GetLocationIndex;
    property ConnectorKind: TConnectorKind read GetConnectorKind
      write SetConnectorKind;
    property ConnectorColor: TCableColor read GetConnectorColor;
    property ConnectorDefColor: TCableColor read GetConnectorDefColor
      write SetConnectorDefColor;
    property ConnectorIndex: byte read GetConnectorIndex
      write SetConnectorIndex;
    property ConnectorType: TConnectorType read GetConnectorType
  ...
  IG2Param = interface(IG2Subject)
    ...
    function CreateMorph(const aMorphIndex, aVariationIndex, aRange: byte)
      : IG2ParamMorph;

    function CreateMessage: TG2SendMessage;
    function CreateUndoMessage: TG2SendMessage;

    procedure AddMessAssignKnob(const aKnob: IG2Knob;
      aSendMessage, aUndoMessage: TG2SendMessage);
    procedure AddMessDeassignKnob(aSendMessage, aUndoMessage: TG2SendMessage);
    procedure AddMessAssignController(const aMidiCC: byte;
      aSendMessage, aUndoMessage: TG2SendMessage);
    procedure AddMessDeassignController(aSendMessage,
      aUndoMessage: TG2SendMessage);
    procedure AddMessAssignGlobalKnob(const aGlobalKnob: IG2Knob;
      aSendMessage, aUndoMessage: TG2SendMessage);
    procedure AddMessDeassignGlobalKnob(aSendMessage,
      aUndoMessage: TG2SendMessage);
    procedure AddMessSetMorph(const aMorph: IG2ParamMorph;
      const aVariation: byte; aSendMessage, aUndoMessage: TG2SendMessage);
    procedure AddMessClearMorph(const aMorph: IG2ParamMorph;
      const aVariation: byte; aSendMessage, aUndoMessage: TG2SendMessage);
    ...
    property Morph[const aMorphIndex, aVariation: byte]: IG2ParamMorph
      read GetMorph;
    ...
    property CanChangeLabel: boolean read GetCanChangeLabel
      write SetCanChangeLabel;
    property LabelOnValue: boolean read GetLabelOnValue; // Switches for example
    property Selected: boolean read GetSelected write SetSelected;
    property InfoFunctionIndex: integer read GetInfoFunctionIndex
      write SetInfoFunctionIndex;
    property ButtonParamIndex: integer read GetButtonParamIndex
      write SetButtonParamIndex;
    property DefaultKnobIndex: integer read GetDefaultKnobIndex
      write SetDefaultKnobIndex;
    ...
    property SuspendUpdate: boolean read GetSuspendUpdate
  ...
  IG2Module = interface(IG2Subject)
    ...
    property ModeInfo[const Index: integer]: TBits6 read GetModeInfo
      write SetModeInfo;
  ...
  IG2Cable = interface(IG2Subject)
    ...
    procedure AddMessCableColor(const aColor: byte;
      aSendMessage, aUndoMessage: TG2SendMessage);
  ...
  TAddModuleEvent = procedure(Sender: TObject; const aLocationIndex: byte;
    aModule: IG2Module) of Object;
  TAddCableEvent = procedure(Sender: TObject; const aLocationIndex: byte;
    aCable: IG2Cable) of Object;
  TLedEvent = procedure(Sender: TObject; const aLocationIndex, aModuleIndex,
    aGroupIndex, aCodeRef, aValue: byte) of Object;
  ...
  IG2PatchPart = interface(IG2Object)
    ...
    procedure AddMessDeleteCable(aCable: IG2Cable;
      aSendMessage, aUndoMessage: TG2SendMessage);
    procedure AddMessAddPatchPart(aDestPatchPart: IG2PatchPart;
      aSendMessage, aUndoMessage: TG2SendMessage);
    ...
    property SelectedParam: IG2Param read GetSelectedParam;
    property FocusedModuleIndex: integer read GetFocusedModuleIndex
      write SetFocusedModuleIndex;
    ...
    property OnAddModule: TAddModuleEvent read GetOnAddModule
      write SetOnAddModule;
  ...
  IG2PatchSettings = interface
    ...
    property YellowVisible: boolean read GetYellowVisible
      write SetYellowVisible;
    property OrangeVisible: boolean read GetOrangeVisible
      write SetOrangeVisible;
    property GreenVisible: boolean read GetGreenVisible write SetGreenVisible;
    property PurpleVisible: boolean read GetPurpleVisible
      write SetPurpleVisible;
  ...
  IG2Patch = interface(IG2Object)
    ...
    procedure SetMorphValue(const aLocationIndex, aModuleIndex, aParamIndex,
      aMorphIndex, aValue, aVariation: byte);
...
{$ENDIF}
    ...
    property VariationCount: integer read GetVariationCount;
    property SelectedMorphIndex: integer read GetSelectedMorphIndex
    ...
    property Modules[LocationIndex, ModuleIndex: integer]: IG2Module
      read GetModule;
    property KnobList: TList<IG2Knob> read GetKnobList;
    property ControllerList: TList<IG2Controller> read GetControllerList;

    property EditAllVariations: boolean read GetEditAllVariations
      write SetEditAllVariations;

    property SelectedLocation: integer read GetSelectedLocation
      write SetSelectedLocation;
    property SelectedParamPage: integer read GetSelectedParamPage
      write SetSelectedParamPage;
    property SelectedParamPageColumn: integer read GetSelectedParamPageColumn
      write SetSelectedParamPageColumn;
  ...
  IG2Slot = interface(IG2Subject)
    ...
    procedure AddMsgGetResourceTable(aMsg: TG2Message;
    ...
    procedure AddMsgCopyVariation(const aFromVariation, aToVariation: byte;
      aMsg: TG2SendMessage);
    procedure AddMsgSelectVariation(const aVariation: byte;
      aMsg: TG2SendMessage);
    procedure AddMsgPatchLoad(aMsg: TG2Message; const aPatchName: string;
      aPatch: IG2Patch);
    ...
    property OperationMode: TOperationMode read GetOperationMode
  ...
  IG2Perf = interface(IG2Object)
    ...
    function FindKnob(const aSlotIndex, aLocationIndex, aModuleIndex,
      aParamIndex: byte): IG2Knob;
    ...
    procedure AddMsgSelectGlobalParamPage(aMsg: TG2SendMessage;
      aPageIndex: byte);

    procedure AddMessAssignGlobalKnobs(aModule: IG2Module;
...
{$ENDIF}
    ...
    procedure DeleteModuleFromPerf(const aSlotIndex, aLocationIndex: byte;
      aModule: IG2Module);

    property PerfVersion: byte read GetPerfVersion write SetPerfVersion;
    property PerformanceName: string read GetPerformanceName
      write SetPerformanceName;
    property SelectedSlotIndex: TBits2 read GetSelectedSlotIndex
      write SetSelectedSlotIndex;
    property MasterClock: TBits8 read GetMasterClock write SetMasterClock;
    property MasterClockRun: TBits8 read GetMasterClockRun
      write SetMasterClockRun;
    property KeyboardRangeEnabled: TBits8 read GetKeyboardRangeEnabled
  ...
  IG2BankItem = interface
    ...
    property PatchFileType: TPatchFileType read GetPatchFileType
      write SetPatchFileType;
  ...
  IG2MidiToKnob = interface
    ...
    property ControlType: TG2ControlType read GetControlType
  ...
  IG2Synth = interface(IG2Object)
    ...
    procedure AddMsgStartStopCommunication(aMsg: TG2SendMessage;
      const Stop: byte);
    procedure AddMsgGetPatchVersion(aMsg: TG2SendMessage);
    ...
    procedure AddMsgListMessage(aMsg: TG2SendMessage;
      const aPatchFileType: TPatchFileType; const aBank, aPatch: byte);
    procedure AddMsgSetModeMessage(aMsg: TG2SendMessage; aMode: byte);
    procedure AddMsgNoteMessage(aMsg: TG2SendMessage; aNote: byte;
      aOnoff: byte);
    procedure AddMsgGetMasterClockMessage(aMsg: TG2SendMessage);
    procedure AddMsgUploadBankMessage(aMsg: TG2SendMessage;
      aPatchFileType: TPatchFileType; aBank, aLocation: byte);
    procedure AddMsgDownloadPatchBankMessage(aMsg: TG2SendMessage;
      aBank, aLocation: byte; aPatchName: string; aPatch: IG2Patch);
    procedure AddMsgDownloadPerfBankMessage(aMsg: TG2SendMessage;
      aBank, aLocation: byte; aPerfName: string; aPerf: IG2Perf);
    procedure AddMsgRetrieveMessage(aMsg: TG2SendMessage;
      aSlot, aBank, aPatch: byte);
    procedure AddMsgStoreMessage(aMsg: TG2SendMessage;
      aSlot, aBank, aPatch: byte);
    procedure AddMsgClearBankMessage(aMsg: TG2SendMessage;
      aPatchFileType: TPatchFileType; aBank, aFromLocation, aToLocation: byte);
    procedure AddMsgClearMessage(aMsg: TG2SendMessage;
      aPatchFileType: TPatchFileType; aBank, aPatch: byte);
    procedure AddMsgSetSynthSettings(aMsg: TG2Message);
    procedure AddMsgSelGlobalParamPage(aMsg: TG2Message; aPageIndex: byte);
    procedure AddMsgSetPerformance(aMsg: TG2SendMessage; aPerfName: string;
      aPerf: IG2Perf);
    ...
    function BankFindFirstLast(aPatchFileType: TPatchFileType; aBank: byte;
      var aFirstLocation, aLastLocation: byte): boolean;

    procedure StartInit(aConnection: IG2Connection);

    procedure AddMidiToKnob(const aSource: TG2ParamSource;
      const aControlType: TG2ControlType; const aKnob: integer;
      const aMidiCC: byte);
    procedure DeleteMidiToKnob(const aSource: TG2ParamSource;
      const aControlType: TG2ControlType; const aKnob: integer);
    function FindMidiToKnob(const aSource: TG2ParamSource;
    ...
    function G2MessageDlg(tekst: string; code: integer): integer;
    ...
    property MidiGlobalChannel: TBits8 read GetMidiGlobalChannel
    ...
    property ProgramChangeReceive: TBits1 read GetProgramChangeReceive
      write SetProgramChangeReceive;
    property ProgramChangeSend: TBits1 read GetProgramChangeSend
      write SetProgramChangeSend;
    property ControllersReceive: TBits1 read GetControllersReceive
      write SetControllersReceive;
    property ControllersSend: TBits1 read GetControllersSend
      write SetControllersSend;
    property SendClock: TBits1 read GetSendClock write SetSendClock;
    property IgnoreExternalClock: TBits1 read GetIgnoreExternalClock
      write SetIgnoreExternalClock;
    property TuneCent: TBits8 read GetTuneCent write SetTuneCent;
    property GlobalOctaveShiftActive: TBits1 read GetGlobalOctaveShiftActive
      write SetGlobalOctaveShiftActive;
    property GlobalOctaveShift: TBits8 read GetGlobalOctaveShift
    ...
    property ControlPedalGain: TBits8 read GetControlPedalGain
      write SetControlPedalGain;

    property BankDumpFolder: string read GetBankDumpFolder
      write SetBankDumpFolder;
    property BankDumpFileName: string read GetBankDumpFileName
      write SetBankDumpFileName;
    property BankDumpList: TStringList read GetBankDumpList;
    property BankDumpListIndex: integer read GetBankDumpListIndex
      write SetBankDumpListIndex;
    property BankDumpDestBank: byte read GetBankDumpDestBank
      write SetBankDumpDestBank;

    property NextBankListCmd: TNextBankListCmd read GetNextBankListCmd
      write SetNextBankListCmd;
    ...
    property SelectedSlotIndex: TBits2 read GetSelectedSlotIndex
      write SetSelectedSlotIndex;
    property AutoAssignMidi: boolean read GetAutoAssignMidi
      write SetAutoAssignMidi;
    property BankItems[const aIndex: integer]: IG2BankItem read GetBankItem
      write SetBankItem;
  ...
  TOnNextMsgEvent = procedure(Sender: TObject; aConnection: IG2Connection)
    of object;
  ...
  IG2Connection = interface(IG2Subject)
    ...
    function GetModule(const aSlotIndex, aLocationIndex, aModuleIndex: integer)
      : IG2Module;
    function GetParam(const aSlotIndex, aLocationIndex, aModuleIndex,
      aParamIndex: integer): IG2Param;
    function GetInConnector(const aSlotIndex, aLocationIndex, aModuleIndex,
      aConnectorIndex: integer): IG2Connector;
    function GetOutConnector(const aSlotIndex, aLocationIndex, aModuleIndex,
      aConnectorIndex: integer): IG2Connector;
    function GetController(const aSlotIndex, aLocationIndex, aModuleIndex,
      aParamIndex: integer): IG2Controller;
    function GetKnob(const aSlotIndex, aLocationIndex, aModuleIndex,
      aParamIndex: integer): IG2Knob;
    function GetGlobalKnob(const aSlotIndex, aLocationIndex, aModuleIndex,
      aParamIndex: integer): IG2Knob;
    ...
    procedure LoadBank(const aPatchType: TPatchFileType;
      const aFileName: string; const aDest: byte);
    procedure SaveBank(const aPatchType: TPatchFileType;
      const aFileName: string; const aSource: byte);
    ...
    procedure ParamControllerAssign(const aSlotIndex, aLocationIndex,
      aModuleIndex, aParamIndex, aMidiCC: byte);
    ...
    procedure ParamGlobalKnobAssign(const aSlotIndex, aLocationIndex,
      aModuleIndex, aParamIndex, aKnobIndex: byte);
    ...
    property PatchPart[const aSlotIndex, aLocationIndex: integer]: IG2PatchPart
      read GetPatchPart;
    property Module[const aSlotIndex, aLocationIndex, aModuleIndex: integer]
      : IG2Module read GetModule;
    property Param[const aSlotIndex, aLocationIndex, aModuleIndex,
      aParamIndex: integer]: IG2Param read GetParam;
    property InConnector[const aSlotIndex, aLocationIndex, aModuleIndex,
      aConnectorIndex: integer]: IG2Connector read GetInConnector;
    property OutConnector[const aSlotIndex, aLocationIndex, aModuleIndex,
      aConnectorIndex: integer]: IG2Connector read GetOutConnector;
    property Controller[const aSlotIndex, aLocationIndex, aModuleIndex,
      aParamIndex: integer]: IG2Controller read GetController;
    property Knob[const aSlotIndex, aLocationIndex, aModuleIndex,
      aParamIndex: integer]: IG2Knob read GetKnob;
    property GlobalKnob[const aSlotIndex, aLocationIndex, aModuleIndex,
      aParamIndex: integer]: IG2Knob read GetGlobalKnob;
    ...
    property SelectedLocationIndex: integer read GetSelectedLocationIndex
      write SetSelectedLocationIndex;
    ...
    property SelectMultiple: boolean read GetSelectMultiple
      write SetSelectMultiple;
    ...
    property LastResponsMessage: byte read GetLastResponsMessage
      write SetLastResponsMessage;
    ...
    property OnDisconnect: TNotifyEvent read GetOnDisconnect
      write SetOnDisconnect;
    property OnProcessResponseMsg: TG2MessageEvent read GetProcessResponseMsg
      write SetProcessResponseMsg;
    property OnProcessSendMsg: TG2MessageEvent read GetProcessSendMsg
      write SetProcessSendMsg;
  ...
  IG2ConnectionManager = interface(IG2Subject)
    ...
    property AutoAssignMidi: integer read GetAutoAssignMidi
      write SetAutoAssignMidi;
    ...
    property SplitterVisible: integer read GetSplitterVisible
      write SetSplitterVisible;
    ...
    property SelectedConnectionIndex: integer read GetSelectedConnectionIndex
      write SetSelectedConnectionIndex;
    property SelectedSlot: IG2Slot read GetSelectedSlot;
    property SelectedSlotIndex: integer read GetSelectedSlotIndex;
    property SelectedPatch: IG2Patch read GetSelectedPatch;
    property SelectedLocationIndex: integer read GetSelectedLocationIndex
    ...
    // property SelectedModuleList: TList<IG2Module> read GetSelectedModuleList;
    // property SelectedModuleCount: integer read GetSelectedModuleCount;
    property SelectedModuleType: byte read GetSelectedModuleType
      write SetSelectedModuleType;
    property FocusedModule: IG2Module read GetFocusedModule;
