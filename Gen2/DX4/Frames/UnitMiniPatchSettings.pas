...
uses
  ...
  FMX.StdCtrls, BVE.NMG2Types, BVE.NMG2File, BVE.NMG2GraphFMX, BVE.NMG2ControlsFMX,
  FMX.Objects;
...
procedure TframePatchSettings.SetStateStyles(
