...
var
  ...
  libusb_ref_device :function(dev: Plibusb_device): libusb_device; cdecl = nil;
  libusb_unref_device : procedure(dev: Plibusb_device); cdecl = nil;
...
begin
  ...
  begin
    ...
    libusb_ref_device := GetProcAddress( LibUSBHandle, 'libusb_ref_device');
    libusb_unref_device := GetProcAddress( LibUSBHandle, 'libusb_unref_device');
    ...
    libusb_get_device_descriptor := GetProcAddress( LibUSBHandle, 'libusb_get_device_descriptor');
