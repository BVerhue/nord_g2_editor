...
begin
  inherited;
  if Value is TBufferedLayout then begin
    Buffered := (Value as TBufferedLayout).Buffered;
    Zoom := (Value as TBufferedLayout).Zoom;
  end else
...
constructor TBufferedLayout.Create(AOwner: TComponent);
begin
  inherited;
...
destructor TBufferedLayout.Destroy;
begin
  inherited;
end;

procedure TBufferedLayout.SetBuffered(const Value: boolean);
var i : integer;
begin
  if FBuffered <> Value then begin
    FBuffered := Value;
...
procedure TBufferedLayout.SetZoom(aValue: single);
var i : integer;
begin
